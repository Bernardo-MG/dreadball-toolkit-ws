...
import com.wandrell.tabletop.dreadball.ws.toolkit.repository.TeamRuleRepository;
import com.wandrell.tabletop.dreadball.ws.toolkit.service.TeamRuleAccessService;

/**
 * Implementation of {@link TeamRuleAccessService} working behind the scenes
 * with JPA.
 * <p>
...
public final class JPATeamRuleAccessService implements TeamRuleAccessService {
     ...
     */
    @Autowired
    public JPATeamRuleAccessService(final TeamRuleRepository repository) {
        super();
